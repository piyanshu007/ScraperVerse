...
const Icon = {
  Logo: () => (
    <svg width="22" height="22" viewBox="0 0 20 20" fill="none">
      <rect x="1" y="1" width="18" height="18" fill="#ff006e" stroke="#000" strokeWidth="1"/>
      <path d="M4 10 L10 4 L16 10 L10 16 Z" fill="#00f5ff"/>
      <circle cx="10" cy="10" r="2.5" fill="#ffe600"/>
    </svg>
  ),
  Monitor: () => (
